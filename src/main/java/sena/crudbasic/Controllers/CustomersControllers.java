...
public class CustomersControllers {
    ...
    @PostMapping("")
    public ResponseEntity<ResponseDto> save(@RequestBody CustomersDto customersDto) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseDto> update(@PathVariable int id, @RequestBody CustomersDto customersDto) {
        try {
